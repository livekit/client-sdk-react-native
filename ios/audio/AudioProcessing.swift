...
extension AVAudioPCMBuffer {
  ...
  public func audioLevels() -> [AudioLevel] {
...
extension Sequence where Iterator.Element == AudioLevel {
  ...
  public func combine() -> AudioLevel? {
    ...
    return AudioLevel(
      average: totalSums.averageSum / Float(count),
