...
extension AVAudioPCMBuffer {
  public func resample(toSampleRate targetSampleRate: Double) -> AVAudioPCMBuffer? {
    ...
    guard let convertedBuffer = AVAudioPCMBuffer(pcmFormat: targetFormat, frameCapacity: AVAudioFrameCount(capacity))
    else {
  ...
  public func convert(toCommonFormat commonFormat: AVAudioCommonFormat) -> AVAudioPCMBuffer? {
